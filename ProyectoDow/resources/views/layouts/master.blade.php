...
<body>
        ...
        <div class="row bg-dark text-white">
            <div class="row">
                ...
                <div class="col-1 text-end d-none d-lg-block">
                    <a href="{{asset('home.login')}}" class="text-white">Cerrar Sesión</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid px-0">
        <nav class="navbar navbar-expand-lg bg-primary navbar-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">Sistema de Gestión de Contenidos (CMS)</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link @if(Route::current()->getName()=='equipos.index') active @endif"  href="{{route('bebidas.index')}}">Bebidas</a>
                        </li>
                        ...
                        <li class="nav-item d-lg-none">
                            <a class="nav-link" href="{{asset('home.login')}}">Cerrar Sesión</a>
                        </li>
